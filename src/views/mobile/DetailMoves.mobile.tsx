...
import MovesHeaderContainer from '~/container/mobile/detail/moves/MovesHeader.container'

const DetailMovesMobile = () => {
  const {
    pokemonDetail,
    pokemonType,
    activeIndex,
    ...
    <div className="w-full min-h-screen bg-primary-4">
      <div className="px-4 py-6">
        ...
        <div className="mt-6 p-4 bg-white rounded-lg">
          <h2 className="text-lg font-bold mb-3">데이터 확인</h2>
