...
export const getServerSideProps: GetServerSideProps = async (props) => {
  ...
  const dynamicSiteMapIds = data.getPokemonFilter.map((pokemon: Pokemon) => {
    return {
  ...
  console.log(dynamicSiteMapIds)

  return getServerSideSitemapLegacy(props, dynamicSiteMapIds)
}
