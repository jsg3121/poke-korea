...
export const QUIZ_MAIN_SEO_CONTENT = {
  title: '포케 코리아 퀴즈에 도전하세요',
  descriptions: [
    '포케 코리아 퀴즈는 포켓몬에 대한 다양한 지식을 테스트할 수 있는 4종류의 퀴즈를 제공합니다. 실루엣 퀴즈, 특성 퀴즈, 타입 퀴즈, 타입 상성 퀴즈까지 총 4가지 유형으로 구성되어 있으며, 각 퀴즈는 20문제 4지선다 객관식으로 진행됩니다.',
    '초보 트레이너부터 포켓몬 마스터까지, 자신의 포켓몬 지식 수준을 확인해보세요. 퀴즈를 완료하면 정답률과 소요 시간을 바로 확인할 수 있습니다.',
  ],
} as const
