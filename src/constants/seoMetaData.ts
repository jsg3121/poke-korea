...
/** 특성 도감 메인 메타데이터 */
export const ABILITY_LIST_META: Metadata = createMetadata(
  '포켓몬 특성 도감 - 포케코리아',
...
/** 타입 상성 메타데이터 */
export const TYPE_EFFECTIVENESS_META: Metadata = createMetadata(
  '포켓몬 상성 계산기 - 포케 코리아',
...
export const MOVES_MAIN_META: Metadata = createMetadata(
...
/** 퀴즈 메인 페이지 메타데이터 */
export const QUIZ_MAIN_META: Metadata = createMetadata(
...
/** 실루엣 퀴즈 페이지 메타데이터 */
export const QUIZ_SILHOUETTE_META: Metadata = createMetadata(
  '포켓몬 실루엣 퀴즈 | 포케 코리아',
...
/** 특성 퀴즈 페이지 메타데이터 */
export const QUIZ_ABILITY_META: Metadata = createMetadata(
  '포켓몬 특성 퀴즈 | 포케 코리아',
...
/** 타입 퀴즈 페이지 메타데이터 */
export const QUIZ_POKEMON_TYPE_META: Metadata = createMetadata(
  '포켓몬 타입 퀴즈 | 포케 코리아',
...
/** 타입 상성 퀴즈 페이지 메타데이터 */
export const QUIZ_TYPE_EFFECTIVENESS_META: Metadata = createMetadata(
  '포켓몬 타입 상성 퀴즈 | 포케 코리아',
