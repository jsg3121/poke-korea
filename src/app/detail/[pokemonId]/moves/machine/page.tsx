...
export const generateMetadata = async ({
  ...
  const title = `${pokemonName}${version ? ` ${version.generationId}세대 ${version.nameKo} 시리즈` : ''} 머신 습득 기술 정보`
  ...
  const canonicalUrl = `https://poke-korea.com/detail/${pokemonId}/moves/machine`
