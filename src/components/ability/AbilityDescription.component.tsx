    ...
    <section className="w-full bg-primary-4 rounded-2xl p-6 mb-6">
      ...
      <div className="space-y-4 text-gray-700">
        <p>
          ...
          3세대에서부터 추가된 포켓몬 각각의 고유한 능력을 뜻합니다. 별도 기술
          발동이나 특별한 행동을 하지 않아도 자동으로 발동되는 능력입니다.
        </p>
        <div className="bg-primary-3 p-4 rounded">
          <p className="font-semibold text-primary-1 mb-2">주요 특징</p>
          <ul className="list-disc list-inside space-y-1 text-primary-1">
        ...
        <div>
          <h3 className="text-lg font-semibold text-primary-1 mb-2">
            특성의 종류
          </h3>
        ...
        <div className="bg-gray-50 border p-4 rounded">
          <p className="text-sm text-gray-600">
            <strong className="text-primary-1">참고:</strong> 레츠고!
