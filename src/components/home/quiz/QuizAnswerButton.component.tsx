...
const QuizAnswerButton = ({
  ...
  return (
    <button
      ...
      className={`w-full h-11 px-4 flex items-center justify-start rounded-lg text-sm text-primary-1 font-medium bg-primary-3 hover:bg-primary-1 hover:text-primary-4 transition-colors duration-200`}
    >
      {label}
    </button>
  )
