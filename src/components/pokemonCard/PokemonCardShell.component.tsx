 ...
 * - 모바일: 144px(하한)~192px(상한) × h-[15.5rem](248px) — 폭은 기기에 따라 유동,
 *   높이는 고정 (144px 2열 그리드 수용, 넓은 기기는 192px까지만 — POKEMON_CARD_SIZE 주석 참조)
 ...
 * 크기가 어긋나면 CLS 발생).
 *
 * 모바일 폭은 144px(w-36) 하한 ~ 192px(max-w-48) 상한의 유동 규격이다. 하한 144는
 * 340px 화면의 2열 그리드 수용을 위한 값(160px는 160×2+여백>308로 넘침, 2026-07-07).
