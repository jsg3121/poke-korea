...
const MovesSearchAndFilter = () => {
  return (
    <article className="w-[calc(100%-2.5rem)] min-h-48 md:w-full mx-auto flex flex-col py-3 gap-3 sticky mb-6 top-16 md:top-40 bg-primary-1 z-10 shadow-[0px_2px_7px_5px_#27374d] px-2 md:px-0">
