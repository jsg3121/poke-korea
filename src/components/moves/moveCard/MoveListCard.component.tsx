...
const MoveCard = ({ moveData }: MoveCardProps) => {
  ...
  return (
    ...
    >
      <article className="w-full min-h-[180px] bg-primary-4 border-[2px] border-solid border-primary-1 rounded-xl shadow-[0_0_0px_3px_var(--color-primary-4)] p-4 relative hover:scale-105 transition-transform">
