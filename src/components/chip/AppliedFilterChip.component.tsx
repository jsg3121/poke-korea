 ...
 *
 * 시각 규격은 Chip 원자(chipStyle)의 기본 칩과 일치: h-7(28px)·rounded-lg·
 * text-sm font-medium·bg-primary-3·흰 글자. 제거 버튼은 실제 <button>(키보드
 * 접근)이고 24px(WCAG 2.5.8 AA 하한) 확보 — 칩 그룹 배치 시 상위에서 간격을
 * 확보한다(chipStyle의 슬림 칩 전제와 동일).
 */
