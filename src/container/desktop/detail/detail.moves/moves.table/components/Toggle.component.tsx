...
const ToggleButtonComponent = ({
  ...
  return (
    <label
      ...
      className="relative inline-flex h-8 w-[6rem] items-center rounded-full cursor-pointer"
    >
      <input
      ...
      <span className="h-8 text-sm text-aligned-base font-bold absolute transform translate-x-[3.5rem] text-primary-4 peer-checked:translate-x-[0.75rem] peer-checked:text-primary-1 select-none">
        {defaultValue ? '레벨업' : '머신'}
      </span>
    </label>
  )
