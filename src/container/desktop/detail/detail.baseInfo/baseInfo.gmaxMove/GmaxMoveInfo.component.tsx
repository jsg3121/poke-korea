    ...
    >
      ...
      <div className="w-full h-[calc(100%-4.25rem)]">
        <div className="w-full h-8 flex align-center bg-primary-2" aria-hidden>
          <p className="w-[45%] h-8 leading-8 text-primary-4 text-center">
            기술명
          </p>
            ...
            <tr className="h-12 [&>td]:align-middle text-base">
              ...
              <td className="text-center justify-items-center">
                <div className="flex items-center gap-3">
                  <span className={`flex-center badge-damage-physical`}>
                    {getDamageTypeKorean('physical')}
                  </span>
                  <span className={`flex-center badge-damage-special`}>
