...
const DescriptionComponent = () => {
  ...
  return (
    <section aria-labelledby="pokemon-base-info" className="card-detail grid">
      ...
      <dl className="w-full">
        <div className="w-full h-12 border-b border-primary-3 border-solid flex items-center gap-2 py-2 last:border-b-0 last:p-0">
          ...
          <dd className="h-10 text-xl text-aligned-lg font-semibold flex items-center gap-2 pokemon-name">
            {name}&nbsp;
            {activeType === 'mega'
              ? '(메가진화)'
              : activeType === 'region'
        ...
        <div className="w-full h-12 border-b border-primary-3 border-solid flex items-center gap-2 py-2 last:border-b-0 last:p-0">
          ...
          <dd
            className="h-10 text-xl text-aligned-lg font-semibold flex items-center gap-2"
