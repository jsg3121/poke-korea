...
const RelationPokemonComponent = ({
  ...
  return (
    <section
      className="w-full h-full bg-primary-4 border-[3px] border-solid border-primary-1 rounded-2xl shadow-[0_0_0px_3px_var(--color-primary-4)] p-4 mx-auto col-span-2"
        ...
        {evolutionId.map((id) => {
          return (
            <li key={`relation-pokemon-id-${id}`}>
              ...
              >
                <ImageComponent
                  src={`${imageMode}/${id}.webp?w=180&h=180`}
                  width="12rem"
                  height="12rem"
