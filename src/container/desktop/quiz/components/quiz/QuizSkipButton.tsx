...
const QuizSkipButton = ({ onClickSkipButton }: QuizSkipButtonProps) => {
  ...
  return (
    <button
      ...
      className="col-span-2 mt-6 mx-auto block w-30 h-8 text-aligned-base text-primary-2 rounded-[1rem] hover:bg-primary-3 hover:text-primary-4 transition-colors"
    >
      건너뛰기
    </button>
  )
