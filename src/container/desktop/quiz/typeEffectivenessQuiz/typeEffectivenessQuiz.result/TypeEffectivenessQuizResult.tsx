              ...
              >
                ...
                <div className="h-8 grid grid-cols-3 gap-3">
                  <p className="h-8 flex-items-gap-2">
                    <span className="h-full text-aligned-base text-base text-primary-1">
                      공격:
                    </span>
                    <TagComponent type={quiz.attackingType as PokemonType} />
                    <span className="h-full text-aligned-base text-xl text-primary-1">
                      →
                    </span>
                  ...
                  <p className="h-8 flex-items-gap-2">
                    <span className="h-full text-base text-aligned-base text-primary-1 font-bold">
                      정답:
                    </span>
                    <span className="h-full text-base text-aligned-base">
                      {correctAnswer}
                    </span>
                  </p>
                  <p className="h-8 flex-items-gap-2">
                    ...
                    <span
                      className={`h-full text-base text-aligned-base font-medium ${isCorrect ? 'text-green-700' : 'text-red-700'}`}
                    >
                      {userAnswer}
                    </span>
                  </p>
