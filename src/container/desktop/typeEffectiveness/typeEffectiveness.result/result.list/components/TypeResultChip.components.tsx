...
const TypeResultChipComponents = ({
  ...
  return (
    <span
      ...
      className="min-w-16 h-12 rounded-2xl text-base leading-[calc(1.5rem+2px)] text-center shadow-[1px_1px_1px_var(--color-primary-3)] drop-shadow-[1px_2px_6px_var(--color-primary-1)] flex gap-1 py-3 pr-4 pl-3"
    >
