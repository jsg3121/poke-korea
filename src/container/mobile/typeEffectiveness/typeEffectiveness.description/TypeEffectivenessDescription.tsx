  ...
  return (
    ...
    >
      <h3
        ...
        className="w-full h-11 text-3xl font-medium text-left leading-[calc(1.5rem+2px)] text-primary-4 border-b border-primary-4 pb-4 mb-4"
      >
        타입별 추가 효과
      </h3>
      <ul className="w-full pl-2.5 list-disc flex flex-col gap-4">
        <li className="w-full min-h-5 text-primary-4">
          <strong className="w-full h-full text-xl text-left leading-[calc(1.25rem+2px)] text-primary-4">
