    ...
    <section aria-labelledby="pokemon-gmax-move" className="w-full card-detail">
      ...
      <div className="w-full">
        <div className="w-full h-8 flex align-center bg-primary-2" aria-hidden>
          <p className="w-[42.5%] h-8 leading-8 text-primary-4 text-center text-base">
            기술명
          </p>
          <p className="w-[27.5%] h-8 leading-8 text-primary-4 text-center text-base">
            타입
          </p>
          <p className="w-[15%] h-8 leading-8 text-primary-4 text-center text-base">
            위력
          </p>
          <p className="w-[15%] h-8 leading-8 text-primary-4 text-center text-base">
            효과
