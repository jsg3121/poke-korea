...
const ZMoveInfoComponent = () => {
  ...
  return (
    <section aria-labelledby="pokemon-z-move" className="w-full card-detail">
          ...
          <tbody>
            {exclusiveZMoves.map((zMove) => (
              ...
              >
                ...
                <td className="text-center justify-items-center">
                  <span
                    className={`w-12 h-6 text-[0.875rem] leading-[calc(1.5rem+2px)] block badge-damage-${zMove.zSkill.damageType}`}
                  >
