  ...
  return (
    <section className="w-full mt-6 pb-8 px-4">
      <header className="mb-4">
        <h1 className="text-2xl font-bold text-primary-4">포켓몬 대회 결과</h1>
      ...
      {tournaments.length === 0 ? (
        <div className="w-full py-12 text-center bg-primary-4 rounded-xl">
          <p className="text-xl mb-2" aria-hidden="true">
            📦
          </p>
          <p className="text-base font-bold text-primary-1">
            대회 데이터를 준비 중입니다
          </p>
        ...
        <ul className="flex flex-col gap-4" aria-label="대회 목록">
