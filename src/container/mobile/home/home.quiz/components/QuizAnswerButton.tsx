...
const QuizAnswerButton = ({
  ...
  return (
    <button
      ...
      className={`w-full h-12 px-4 text-aligned-xl rounded-lg text-left text-primary-1 font-medium bg-primary-3 hover:bg-primary-1 hover:text-primary-4 transition-colors duration-200`}
    >
      {label}
    </button>
  )
