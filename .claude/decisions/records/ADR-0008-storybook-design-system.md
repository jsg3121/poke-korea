...
UI 전면 개편([mobile-redesign-plan.md](../../specs/plans/mobile-redesign-plan.md))과 함께 내부 디자인 시스템을 구축하기로 했고, 초기에는 **claude.ai/design**(`poke-korea-design-system` 프로젝트)을 시각적 single source of truth로 삼아 Foundations/Components 카드를 업로드했다.
...
- `DesignSync` 연동을 다루던 문서 갱신:
  - [mobile-redesign-plan.md](../../specs/plans/mobile-redesign-plan.md) §3.3 DS 트랙: claude.ai/design → Storybook
...
- 이후 디자인 시스템 구축은 Storybook에서 Foundations → Components → Patterns 순으로 진행([home-redesign-spec.md](../../specs/features/home-redesign-spec.md) 계획 유지).
...
- [mobile-redesign-plan.md](../../specs/plans/mobile-redesign-plan.md) — UI 전면 개편 4단계 전략
- [home-redesign-spec.md](../../specs/features/home-redesign-spec.md) — 홈 재설계 (DS 컴포넌트 계획)
