...
- **상태**: 승인
- **날짜**: 2026-06-25 (2026-06-28 칩으로 범위 확장)
- **담당**: jsg3121 + Claude
...
4. **적용 범위는 슬림 인터랙티브(탭·칩)로 한정**한다. 버튼·CTA·기타 인터랙티브 요소의
   44px(`min-h-touch`) 규칙은 그대로 유지한다.
...
5. styling.md 터치 타겟 규칙에 이 예외(탭·칩)를 명시한다.
...
- styling.md 터치 타겟 규칙에 슬림 인터랙티브(탭·칩) 예외가 명시됐다.
