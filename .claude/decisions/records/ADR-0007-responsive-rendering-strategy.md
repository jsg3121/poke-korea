...
[ADR-0006](./ADR-0006-adaptive-rendering-strategy.md)은 렌더링 전략을 **순수 적응형(Adaptive)** 으로 정했다. 그 핵심 근거는 _"이미 page 38개가 UA 분기 구조이므로, 현 구조를 활용하는 것이 전면 재작성보다 비용 대비 합리적"_ 이었다.
