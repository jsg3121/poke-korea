...
> **연관 문서**:
>
> - 시장 조사: `.claude/research/market/MI-2026-05-04-poke-korea-traffic-growth.md`
> - 경쟁력 분석: `.claude/research/business/BA-2026-05-04-poke-korea-competitiveness.md`
> - 실행 전략: `.claude/research/strategy/STR-2026-05-04-poke-korea-traffic-growth.md` (v3)
> - 지표 기준값: `.claude/specs/service/metrics-baseline.md`
