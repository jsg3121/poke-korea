...
| 산출 문서     | 위치                                                               | 역할                |
| ------------- | ------------------------------------------------------------------ | ------------------- |
| 리서치 보고서 | `.claude/research/market/MI-BA-2026-05-28-champions-pikalytics.md` | MI + BA 종합 분석   |
| 신규 SPEC     | `.claude/specs/features/champions-pikalytics-enhancement.md`       | Phase 1~5 실행 계획 |
