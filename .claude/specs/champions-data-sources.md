...
> **연결 문서**: `.claude/research/reports/MI-BA-2026-05-28-champions-pikalytics.md`, `.claude/specs/champions-pikalytics-enhancement.md` > **작성일**: 2026-05-28
...
| TeamSlot 세부 (포켓몬, 기술 4, 특성, 도구, EV, 테라스탈 타입) | `TeamSlot { pokemonId, moves[4], ability, item, evs, teraType }` |
