...
> 마지막 갱신: 2026-05-11 (1.42.0 머지 — 챔피언스 홈 상위 티어 전용 쿼리 적용 및 모바일 가로 스크롤 전환)
...
- 단계 D 착수 (D-1 이로치 URL 정적 경로 마이그레이션)
- 단계 E 백엔드 협업 항목 일정 협의 (E-1 Z-A, E-2 챔피언스 기술 섹션, E-3 OG 이미지)
- 단계 F 운영/외부 항목 검토 (F-1 네이버 블로그, F-2 GA4 측정 기준값 수집)
- 효과 측정 결과 기록 (1.39.0/1.40.0/1.42.0 배포 후 각 4~8주, 네이버 SC + 구글 SC + GA4)
