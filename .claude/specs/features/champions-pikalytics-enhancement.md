...
> **연결 문서**:
>
> - 근거 보고서: `.claude/research/market/MI-BA-2026-05-28-champions-pikalytics.md`
> - **프론트엔드 페이지 단위 실행 계획**: `.claude/specs/plans/champions-frontend-implementation-plan.md` (2026-05-31 추가)
> - 기존 챔피언스 계획서: `.claude/specs/plans/champions-implementation-plan.md` (고도화 트랙 분리 섹션과 연결)
>   **작성일**: 2026-05-28
...
본 SPEC은 **기능 단위(포맷분리 / 레이팅 / 카운터 / EV / 대회)** 로 작성된 통합 계획이다. 실제 프론트 작업은 페이지 단위로 묶는 것이 작업 경계가 명확하기 때문에, **프론트엔드 실행은 [`champions-frontend-implementation-plan.md`](../plans/champions-frontend-implementation-plan.md) 를 따른다**.
...
| 선행 작업                                                                               | 담당   | 완료 조건                                     |
| --------------------------------------------------------------------------------------- | ------ | --------------------------------------------- |
| GraphQL 스키마 확장 (`format`, `usageByRating`, `counters`, `evSpreads`, `tournaments`) | 백엔드 | 백엔드 저장소의 페이지×엔드포인트 매핑에 따라 |
...
- [ ] 6마리 풀빌드(기술 4 + 특성 + 도구 + EV + 테라스탈) 정상 노출
...
- 본 SPEC의 근거 보고서: `.claude/research/market/MI-BA-2026-05-28-champions-pikalytics.md`
- 기존 챔피언스 계획서: `.claude/specs/plans/champions-implementation-plan.md`
- 외부:
