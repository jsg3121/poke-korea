...
> **버전**: 1.54.0
> **상태**: 설계 확정 (구현 대기)
> **범위**: 홈(`/`) 페이지 반응형 단일 뷰 재구성 — [UI 전면 개편 4단계 전략](../plans/mobile-redesign-plan.md)의 2단계 첫 페이지
...
- [.claude/specs/plans/mobile-redesign-plan.md](../plans/mobile-redesign-plan.md) — UI 전면 개편 4단계 전략
