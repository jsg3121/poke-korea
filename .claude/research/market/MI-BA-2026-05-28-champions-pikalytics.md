...
> **연결 SPEC**: `.claude/specs/features/champions-pikalytics-enhancement.md`
...
- 내부 문서:
  - `.claude/specs/features/champions-api-frontend-spec.md`
  - `.claude/specs/plans/champions-implementation-plan.md`
  - `.claude/specs/features/champions-pikalytics-enhancement.md` (본 작업 산출물)
