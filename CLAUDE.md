...
│   ├── competitive-audit/     #   /competitive-audit (references/ 포함)
│   ├── research/              #   /research (자동 트리거)
│   ├── weekly-growth-review/  #   /weekly-growth-review (자동 트리거, references/ 포함)
│   └── growth-sprint/         #   /growth-sprint (자동 트리거, references/ 포함)
├── agents/                    # 에이전트 정의
│   ├── seo-specialist.md      #   SEO 전문가
│   ├── ui-publisher.md        #   UI 구현 전문가
│   ├── graphql-specialist.md  #   GraphQL 전문가
│   ├── tool-designer.md       #   도구/계산기 설계 전문가
│   ├── growth-analyst.md      #   유입/퍼널/리텐션 데이터 분석
│   ├── competitive-watcher.md #   경쟁사 동향 모니터링
│   ├── user-insight-analyst.md #  사용자 행동/VOC 분석
│   └── growth-strategist.md   #   성장 전략 종합 → 실행 액션 도출
...
| 성장 분석 | `.claude/specs/`, `.claude/outputs/` |
| 경쟁 분석 | `.claude/specs/competitor-map.md`, `.claude/skills/competitive-audit/` |
